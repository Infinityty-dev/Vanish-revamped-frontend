...
- Service Provider refers to vanISH, a logistics company.
...
<p>- The Service Provider (vanISH) shall provide the Van Owner with access to its logistics platform.
...
<p>- The Service Provider (vanISH) shall pay the Van Owner for Services rendered.
...
<p>The Van Owner shall indemnify and hold harmless the Service Provider (vanISH) against any claims, damages, or expenses arising from the provision of Services.</p>

<h5>8. TERMINATION </h5>
<p>This Agreement may be terminated by either party under the following conditions:
- Breach of Agreement: vanISH reserves the right to terminate this Agreement upon seven (7) days' written notice.
